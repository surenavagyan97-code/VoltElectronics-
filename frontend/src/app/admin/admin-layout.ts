  ...
  template: `
    <div style="display: flex; flex-direction: column; min-height: 100vh;">
      ...
      <div class="admin-sidebar">
        ...
        <a routerLink="/admin/content" routerLinkActive="active" class="admin-nav-link">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>
          {{ i18n.t('admin.nav.content') }}
        </a>
        <a routerLink="/admin/promotions" routerLinkActive="active" class="admin-nav-link">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="m20.59 13.41-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><circle cx="7.5" cy="7.5" r="1.5"></circle></svg>
          {{ i18n.t('admin.nav.promotions') }}
        </a>
        ...
        <a routerLink="/admin/couriers" routerLinkActive="active" class="admin-nav-link">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="1" y="3" width="15" height="13" rx="1"></rect><path d="M16 8h4l3 4v4h-7V8z"></path><circle cx="5.5" cy="18.5" r="2"></circle><circle cx="18.5" cy="18.5" r="2"></circle></svg>
          {{ i18n.t('admin.nav.couriers') }}
        </a>
