...
namespace VoltElectronics.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260817135851_AddPromotionsAndDiscounts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VoltElectronics.Domain.Catalog.ProductTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VoltElectronics.Domain.Content.ContentPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VoltElectronics.Domain.Promotions.Promotion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VoltElectronics.Domain.Promotions.PromotionProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VoltElectronics.Domain.Promotions.Promotion", b =>
                {
                    b.HasOne("VoltElectronics.Domain.Catalog.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
            ...
            modelBuilder.Entity("VoltElectronics.Domain.Promotions.PromotionProduct", b =>
                {
                    ...
                    b.HasOne("VoltElectronics.Domain.Promotions.Promotion", null)
                        .WithMany("Products")
